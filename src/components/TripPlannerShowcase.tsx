        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="pt-4">
              <Link
                href="/trip-planner"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-white text-brand-blue hover:bg-brand-50 transition-all font-extrabold text-base shadow-xl hover:scale-105 active:scale-95 group"
              >
