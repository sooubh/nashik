...
import { Star, MapPin, Sparkles, QrCode, ShieldCheck, Download, Sun, ChevronRight, CheckCircle2 } from 'lucide-react';
...
export function Hero() {
  ...
  return (
    <>
      <section className="relative pt-32 sm:pt-36 pb-20 md:pb-28 px-4 sm:px-6 md:px-8 max-w-7xl mx-auto overflow-hidden bg-grid-pattern">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-brand-200/80 dark:border-brand-800/80 shadow-soft-sm text-brand-blue dark:text-brand-300 text-xs font-bold uppercase tracking-wider mb-6"
            >
            ...
            {/* Description */}
            <p className="text-slate-600 dark:text-slate-300 text-base sm:text-lg font-normal leading-relaxed max-w-2xl mx-auto lg:mx-0 mb-8">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 mb-12">
              <a
                ...
                className="inline-flex items-center gap-3 px-6 sm:px-7 py-3.5 rounded-2xl text-white bg-brand-blue hover:bg-brand-700 transition-all font-bold text-sm shadow-glow-sm hover:scale-105 active:scale-95 group"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-2xl text-slate-800 dark:text-slate-100 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-brand-300 dark:hover:border-brand-700 hover:text-brand-blue dark:hover:text-brand-400 font-bold text-sm transition-all shadow-soft-sm hover:scale-105 active:scale-95"
              >
            ...
            {/* Quick Metrics */}
            <div className="grid grid-cols-3 gap-4 border-t border-slate-200/80 dark:border-slate-800/80 pt-6 max-w-lg mx-auto lg:mx-0">
              <div>
                <div className="flex items-center justify-center lg:justify-start gap-1.5 text-amber-500 font-black text-2xl sm:text-3xl">
                  <span>4.8</span>
              ...
              <div className="border-l border-slate-200/80 dark:border-slate-800/80 pl-4">
                <span className="block text-2xl sm:text-3xl font-black text-brand-blue dark:text-brand-400">
                  50k+
                </span>
                <span className="text-[11px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 block mt-0.5">
                  Downloads
              ...
              <div className="border-l border-slate-200/80 dark:border-slate-800/80 pl-4">
                <div className="flex items-center justify-center lg:justify-start gap-1.5 text-emerald-600 dark:text-emerald-400 font-black text-2xl sm:text-3xl">
                  <span>100%</span>
          ...
          >
            ...
            <motion.div
              ...
              className="hidden sm:flex absolute -left-8 top-12 z-20 items-center gap-3 p-3.5 glass-card rounded-2xl shadow-soft-lg"
            >
            ...
            <motion.div
              ...
              className="hidden sm:flex absolute -right-6 bottom-24 z-20 items-center gap-3 p-3.5 glass-card rounded-2xl shadow-soft-lg"
            >
              ...
              <div>
                <span className="font-extrabold text-xs block text-slate-900 dark:text-white">Trimbakeshwar Shiva</span>
            ...
            <motion.div
              ...
              className="hidden sm:flex absolute right-4 top-2 z-20 items-center gap-2 px-3.5 py-2 glass-card rounded-full shadow-soft-md text-xs"
            >
            ...
            >
              <div className="relative w-[285px] sm:w-[315px] aspect-[9/19] bg-slate-950 rounded-[48px] p-3 shadow-2xl border-4 border-slate-800 ring-8 ring-slate-900/40 ring-offset-4 ring-offset-slate-100 dark:ring-offset-slate-950 overflow-hidden">
                {/* Notch */}
                <div className="absolute top-2 left-1/2 -translate-x-1/2 h-5 w-24 bg-slate-900 rounded-full z-30 flex items-center justify-center">
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      <Image
                        ...
                        sizes="(max-width: 768px) 285px, 315px"
                      />
                    </motion.div>
                  </AnimatePresence>
                </div>
            ...
            <div className="flex items-center gap-1.5 mt-6 p-1.5 rounded-full glass-card shadow-soft-sm">
