...
export function FeatureShowcase() {
  ...
  return (
    <section id="features" className="py-24 px-4 sm:px-6 md:px-8 bg-slate-50/50 dark:bg-slate-900/20 border-y border-slate-200/80 dark:border-slate-800/80 transition-colors">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            {featuresData.map((feature, idx) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  className={cn(
                    'w-full text-left p-5 rounded-2xl transition-all duration-200 border relative focus:outline-none flex items-start gap-4 cursor-pointer',
                    isSelected
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2 mb-1">
                      ...
                      {feature.badge && (
                        <span
                          className={cn(
                            'text-[10px] uppercase font-bold px-2.5 py-0.5 rounded-full shrink-0',
                            isSelected
          ...
          <div className="lg:col-span-6 flex flex-col items-center order-1 lg:order-2 gap-8">
            {/* Phone Shell */}
            <div className="relative w-[280px] sm:w-[310px] aspect-[9/19] bg-slate-950 rounded-[48px] p-3 shadow-2xl border-4 border-slate-800 ring-4 ring-slate-900/40 overflow-hidden">
            ...
            {/* Architecture Card */}
            <div className="w-full max-w-md p-6 glass-card rounded-3xl shadow-soft-sm">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs font-medium text-slate-700 dark:text-slate-300">
                <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400">
                  ...
                  <span>Hive DB Local Cache</span>
                </div>
                <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400">
                  <CheckCircle2 className="w-3.5 h-3.5 shrink-0" />
                  <span>Riverpod State Flow</span>
                </div>
                <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400">
                  <CheckCircle2 className="w-3.5 h-3.5 shrink-0" />
