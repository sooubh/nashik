...
export function DeleteAccountClient() {
  ...
  return (
    <div className="pt-28 sm:pt-32 pb-16 sm:pb-24 px-4 sm:px-6 md:px-8 max-w-5xl mx-auto space-y-8 sm:space-y-10">
      {/* Top Back Nav */}
      <div className="flex items-center justify-between">
        ...
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-50 dark:bg-rose-950/60 text-rose-600 dark:text-rose-400 text-xs font-bold border border-rose-200/60 dark:border-rose-800/60">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-soft-sm flex flex-col justify-between">
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-850 text-slate-800 dark:text-slate-200 text-base sm:text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 min-h-[46px]"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-850 text-slate-800 dark:text-slate-200 text-base sm:text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 min-h-[44px]"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-3.5 rounded-2xl text-white font-extrabold text-xs sm:text-sm bg-rose-600 hover:bg-rose-700 transition-all shadow-md shadow-rose-600/20 flex items-center justify-center gap-2 disabled:opacity-50 min-h-[46px] cursor-pointer"
              >
                {isSubmitting ? (
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-soft-sm space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-4 rounded-2xl bg-white dark:bg-slate-850 border border-slate-200/70 dark:border-slate-800 space-y-2">
            <div className="p-2 rounded-xl bg-rose-50 dark:bg-rose-950 text-rose-600 dark:text-rose-400 w-fit">
          ...
          <div className="p-4 rounded-2xl bg-white dark:bg-slate-850 border border-slate-200/70 dark:border-slate-800 space-y-2">
            <div className="p-2 rounded-xl bg-amber-50 dark:bg-amber-950 text-amber-600 dark:text-amber-400 w-fit">
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => setIsSubmitted(false)}
                type="button"
                className="w-full py-3.5 rounded-xl text-white bg-slate-900 dark:bg-slate-800 hover:bg-slate-800 font-bold text-sm transition-all min-h-[44px] cursor-pointer"
              >
                Dismiss
              </button>
            </motion.div>
